...
namespace ComiqueriaApp
{
    public partial class PrincipalForm : Form
    {
        ...
        public PrincipalForm()
        {
            ...
            //Productos
            Producto producto1 = new Comic("AMAZING SPIDER-MAN 01: SUERTE DE ESTAR VIVO", 5, 560.00, "Dan Slott", Comic.TipoComic.Ocidental);
        ...
        private void BtnVender_Click(object sender, EventArgs e)
        {
            ...
            Form ventasForm = new formVentas(comiqueria ,productoSeleccionado);
